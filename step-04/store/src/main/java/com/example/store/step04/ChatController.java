...
import com.example.store.step04.model.OrderLine;
...
public class ChatController {
    ...
    public ChatController(DaprWorkflowClient daprWorkflowClient) {
    ...
    public String placeOrder(List<OrderLine> items, List<MerchItem> inventory) {
        ...
        daprWorkflowClient.scheduleNewWorkflow("ProcessOrderWorkflow", order, orderId);
